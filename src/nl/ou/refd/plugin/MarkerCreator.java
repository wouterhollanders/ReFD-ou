...
/**
 * Central class to place source markers in a project. These markers show up in
 * the problems section of the Eclipse environment.
 */
class MarkerCreator {
	...
	/**
	 * Place a default marker on a location in the project. Default markers show up
	 * as information markers, meaning they are neither an error, nor a warning.
	 * 
	 * @param label    the label (description) for the marker
	 * @param location the location within the project
	 * @param sc       the source file and location in this file. If sc is null, the
	 *                 entire project is chosen as correspondence.
	 */
