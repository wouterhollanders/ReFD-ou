...
/**
 * Class representing a Combine Methods into Class refactoring. This refactoring
 * can be analyzed by using a DangerAnalyzer object.
 */
public class CombineMethodsIntoClass extends Refactoring {
	...
	/**
	 * Creates the Combine Methods into Class refactoring with a destinitian class
	 * which will be created, and a list of target methods which will be moved to
	 * the newly created destination class.
	 * 
